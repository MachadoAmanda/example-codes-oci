...
# Texto com informações sensíveis
texto = """
Hello, my name is Amanda Silva, document number 123.456.789-00.
My e-mail is amanda.silva@email.com and my phone is (11) 91234-5678.
"""
...
ai_client = oci.ai_language.AIServiceLanguageClient(oci.config.from_file("~/.oci/config", "SAOPAULO"))
